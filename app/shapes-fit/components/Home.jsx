...
export default function Home({ gameOverUpdate, score,scoreUpdate}){
    ...
    return (
        <div className={style['home-container']}>
            ...
            <div className={style['home-button']} onClick={() => {gameOverUpdate(false);scoreUpdate(0);updateGamesPlayedCount()}}>Play</div>
        </div>
    );
};
